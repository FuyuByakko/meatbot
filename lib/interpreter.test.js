...
const { createBrowser: browserInstance } = require('./browser');
...
describe('IntepretorBuilder', () => {
  ...
  test('should throw error when passed a bad action type', async () => {
    const interpreter = interpreterBuilder(page);
    ...
    await expect(interpreter(script)).rejects.toThrow()
  });
